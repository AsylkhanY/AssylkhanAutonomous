...
public class BlueAutonomousFAR extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if(left){
                /*
                goToPosition(10 * COUNTS_PER_INCH, 28 * COUNTS_PER_INCH, 0.5, 90, 7 * COUNTS_PER_INCH, 5,true);
                goToPosition(-21 * COUNTS_PER_INCH, 28 * COUNTS_PER_INCH, 0.5, 90, 2 * COUNTS_PER_INCH, 2,false);
                cylinder.setPower(1);
                sleep(2000);
                cylinder.setPower(0);
                goToPosition(-51.5 * COUNTS_PER_INCH, 28 * COUNTS_PER_INCH, 0.4, 90, 2 * COUNTS_PER_INCH, 2,false);
                goToPosition(-51.5 * COUNTS_PER_INCH, 55 * COUNTS_PER_INCH, 0.5, 90, 2 * COUNTS_PER_INCH, 2,true);
                goToPosition(-75 * COUNTS_PER_INCH, 55 * COUNTS_PER_INCH, 0.5, 90, 2 * COUNTS_PER_INCH, 2,true);
                goToPosition(-85 * COUNTS_PER_INCH, 21.5 * COUNTS_PER_INCH, 0.5, 91.5, 2 * COUNTS_PER_INCH, 2,false);
                ...
                sleep(2000);
                cylinder.setPower(0);
                goToPosition(5 * COUNTS_PER_INCH, 30 * COUNTS_PER_INCH, 0.5, -90, 2 * COUNTS_PER_INCH, 2,true);
                goToPosition(0 * COUNTS_PER_INCH, 60 * COUNTS_PER_INCH, 0.5, 90, 2 * COUNTS_PER_INCH, 2,true);
                goToPosition(-60 * COUNTS_PER_INCH, 60 * COUNTS_PER_INCH, 0.5, 90, 2 * COUNTS_PER_INCH, 2,true);
                goToPosition(-75 * COUNTS_PER_INCH, 55 * COUNTS_PER_INCH, 0.5, 90, 2 * COUNTS_PER_INCH, 2,true);
                goToPosition(-85 * COUNTS_PER_INCH, 20 * COUNTS_PER_INCH, 0.5, 91.5, 2 * COUNTS_PER_INCH, 2,false);
                goToPosition(-93.7 * COUNTS_PER_INCH, 20 * COUNTS_PER_INCH, 0.3, 91.5, 2 * COUNTS_PER_INCH, 1,false);
                ...
                sleep(1300);
                left_front.setPower(-0.15);
                left_back.setPower(-0.15);
                right_front.setPower(-0.15);
                right_back.setPower(-0.15);
                sleep(700);
                ...
                goToPosition(0 * COUNTS_PER_INCH, 30 * COUNTS_PER_INCH, 0.5, 0, 2 * COUNTS_PER_INCH, 2,false);
                cylinder.setPower(1);
                sleep(2000);
                cylinder.setPower(0);
                goToPosition(0 * COUNTS_PER_INCH, 24 * COUNTS_PER_INCH, 0.5, 90, 2 * COUNTS_PER_INCH, 2,false);
                goToPosition(0 * COUNTS_PER_INCH, 28 * COUNTS_PER_INCH, 0.5, 90, 2 * COUNTS_PER_INCH, 2,true);
                goToPosition(-60 * COUNTS_PER_INCH, 26.5 * COUNTS_PER_INCH, 0.5, 90, 2 * COUNTS_PER_INCH, 2,true);
                goToPosition(-80 * COUNTS_PER_INCH, 28 * COUNTS_PER_INCH, 0.5, 91.5, 3 * COUNTS_PER_INCH, 2,false);
                goToPosition(-93 * COUNTS_PER_INCH, 28 * COUNTS_PER_INCH, 0.3, 91.5, 1 * COUNTS_PER_INCH, 1,false);
                leftLift.setPower(0.5);
                rightLift.setPower(0.5);
                sleep(200);
                leftLift.setPower(0);
                ...
                goToPosition(3 * COUNTS_PER_INCH, 30 * COUNTS_PER_INCH, 0.5, 90, 1.5 * COUNTS_PER_INCH, 2,false);
                cylinder.setPower(1);
                sleep(2000);
                cylinder.setPower(0);
                goToPosition(0 * COUNTS_PER_INCH, 60 * COUNTS_PER_INCH, 0.5, 90, 2 * COUNTS_PER_INCH, 2,true);
                goToPosition(-60 * COUNTS_PER_INCH, 60 * COUNTS_PER_INCH, 0.5, 90, 2 * COUNTS_PER_INCH, 2,true);
                goToPosition(-80 * COUNTS_PER_INCH, 33 * COUNTS_PER_INCH, 0.5, 90, 2 * COUNTS_PER_INCH, 2,false);
                goToPosition(-92 * COUNTS_PER_INCH, 33 * COUNTS_PER_INCH, 0.3, 91.5, 1 * COUNTS_PER_INCH, 1,false);
                leftLift.setPower(0.5);
                rightLift.setPower(0.5);
                sleep(200);
                leftLift.setPower(0);
