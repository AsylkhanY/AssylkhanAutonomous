...
public class BlueAutonomous extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            goToPosition(0 * COUNTS_PER_INCH, 0 * COUNTS_PER_INCH, 0.5, 0, 1.5 * COUNTS_PER_INCH, 2,false);


            /*
            if(left){
                goToPosition(-20 * COUNTS_PER_INCH, 35 * COUNTS_PER_INCH, 0.5, 90, 1.5 * COUNTS_PER_INCH, 2,false);
                cylinder.setPower(1);
                ...
                intake2.setPower(0);
                cylinder.setPower(0);
                goToPosition(-30 * COUNTS_PER_INCH, 23 * COUNTS_PER_INCH, 0.5, 90, 5 * COUNTS_PER_INCH, 5,false);
                goToPosition(-39.5 * COUNTS_PER_INCH, 23 * COUNTS_PER_INCH, 0.5, 90, 1 * COUNTS_PER_INCH, 1.5,false);
                ...
                goToPosition(-32 * COUNTS_PER_INCH, 57 * COUNTS_PER_INCH, 0.65, 90, 2 * COUNTS_PER_INCH, 3,true);
                goToPosition(-45 * COUNTS_PER_INCH, 57 * COUNTS_PER_INCH, 0.65, 90, 2 * COUNTS_PER_INCH, 3,false);

            }
            else if(center){
                goToPosition(-10 * COUNTS_PER_INCH, 42 * COUNTS_PER_INCH, 0.5, 90, 2 * COUNTS_PER_INCH, 2,false);
                cylinder.setPower(1);
                intake1.setPower(-0.2);
                intake2.setPower(-0.2);
                sleep(2000);
                ...
                intake2.setPower(0);
                cylinder.setPower(0);
                goToPosition(-25 * COUNTS_PER_INCH, 31 * COUNTS_PER_INCH, 0.5, 90, 5 * COUNTS_PER_INCH, 5,false);
                goToPosition(-42 * COUNTS_PER_INCH, 31 * COUNTS_PER_INCH, 0.5, 90, 1 * COUNTS_PER_INCH, 1.5,false);
                leftLift.setPower(0.2);
                rightLift.setPower(0.2);
                sleep(300);
                leftLift.setPower(0);
                ...
                goToPosition(4 * COUNTS_PER_INCH, 30 * COUNTS_PER_INCH, 0.5, 90, 2 * COUNTS_PER_INCH, 2,false);
                cylinder.setPower(1);
                intake1.setPower(-0.2);
                intake2.setPower(-0.2);
                sleep(2000);
                ...
                intake2.setPower(0);
                cylinder.setPower(0);
                goToPosition(-25 * COUNTS_PER_INCH, 37.5 * COUNTS_PER_INCH, 0.5, 90, 5 * COUNTS_PER_INCH, 5,false);
                goToPosition(-39.5 * COUNTS_PER_INCH, 37.5 * COUNTS_PER_INCH, 0.5, 90, 1 * COUNTS_PER_INCH, 1.5,false);
                leftLift.setPower(0.2);
                rightLift.setPower(0.2);
                sleep(300);
