...
public class Drivetrain {
    ...
    public void init(HardwareMap ahwMap) {
        ...
        // Control HUb
        topLeftDriveMotor = hwMap.get(DcMotor.class, "left_front_drive");
        bottomLeftDriveMotor = hwMap.get(DcMotor.class, "left_back_drive");
        topRightDriveMotor = hwMap.get(DcMotor.class, "right_front_drive");
        bottomRightDriveMotor = hwMap.get(DcMotor.class, "right_back_drive");
