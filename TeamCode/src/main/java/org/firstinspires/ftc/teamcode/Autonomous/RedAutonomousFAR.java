...
public class RedAutonomousFAR extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if(left){
                goToPosition(-13 * COUNTS_PER_INCH, 23 * COUNTS_PER_INCH, 0.5, 0, 1.5 * COUNTS_PER_INCH, 2,false);
                cylinder.setPower(0.8);
                ...
                intake2.setPower(0);
                cylinder.setPower(0);
                goToPosition(-13 * COUNTS_PER_INCH, 20 * COUNTS_PER_INCH, 0.5, 0, 1.5 * COUNTS_PER_INCH, 2,false);

            }
            else if(center){
                goToPosition(-3 * COUNTS_PER_INCH, 30.5 * COUNTS_PER_INCH, 0.5, 0, 2 * COUNTS_PER_INCH, 2,false);
                cylinder.setPower(0.8);
                intake1.setPower(-0.2);
                intake2.setPower(-0.2);
                sleep(2000);
                ...
                intake2.setPower(0);
                cylinder.setPower(0);
                goToPosition(-3 * COUNTS_PER_INCH, 25 * COUNTS_PER_INCH, 0.5, 0, 2 * COUNTS_PER_INCH, 2,false);

            }
            else{
                goToPosition(-10 * COUNTS_PER_INCH, 30 * COUNTS_PER_INCH, 0.5, 90, 7 * COUNTS_PER_INCH, 5,true);
                goToPosition(4.5 * COUNTS_PER_INCH, 30 * COUNTS_PER_INCH, 0.5, 90, 2 * COUNTS_PER_INCH, 2,false);
                cylinder.setPower(0.8);
                ...
                intake2.setPower(0);
                cylinder.setPower(0);
                goToPosition(0 * COUNTS_PER_INCH, 30 * COUNTS_PER_INCH, 0.5, 90, 2 * COUNTS_PER_INCH, 2,false);
