...
public class GlobalCoordinatePositionUpdateSample extends LinearOpMode {
    ...
    String verticalLeftEncoderName = "left_front_drive", verticalRightEncoderName = "left_back_drive", horizontalEncoderName = "right_front_drive";

    @Override
    public void runOpMode() throws InterruptedException {

        //ReadWriteFile.writeFile(wheelBaseSeparationFile, String.valueOf(10.95));
        //ReadWriteFile.writeFile(horizontalTickOffsetFile, String.valueOf(-2300));
