...
public class easyopencv extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            */
            ...
            if(center){
                encoder(1300,LeftDrive);
                encoder(1300,RightDrive);
                busy();
                encoder(760,LeftDrive);
                encoder(760,RightDrive);
                busy();
                encoder(200,LeftDrive);
                encoder(1320,RightDrive);
            }
            else if(left){
                encoder(800,RightDrive);
                encoder(800,LeftDrive);
                busy();
                encoder(800, RightDrive);
                encoder(1920, LeftDrive);
                busy();
                encoder(880, RightDrive);
                encoder(2000, LeftDrive);
                busy();
            }
            else {
                encoder(1080, LeftDrive);
                encoder(1080, RightDrive);
                busy();
            ...
            //sleep(500);
            //AprilTag(NeededID);
            encoderp(2240, RightDrive);
            encoderp(2240, LeftDrive);
            busy();
            Lift1.setPower(1);
            Lift2.setPower(1);
            sleep(300);
    ...
    public void encoderp(int tick, DcMotor motor){
        //newTarget = ticks/turnage + motor.getCurrentPosition();
        newTarget = tick + motor.getCurrentPosition();
        motor.setTargetPosition((int)newTarget);
        motor.setPower(0.3);
        motor.setMode(DcMotor.RunMode.RUN_TO_POSITION);
    }
